...
def calculate_demographic_data(print_data=True):
    ...
    age_series = []
    average_age_men = round(df.mean('age' == 'Male')['age'],1)
    ...
    # Experiments
    number_of_high_earners = df['salary'].value_counts()['>50K']
    ...
    higher_education = round(high_ed_and_high_earners.shape[0]/number_of_records*100, 1)
    lower_education = round(low_ed_and_high_earners.shape[0]/number_of_records*100,1)
